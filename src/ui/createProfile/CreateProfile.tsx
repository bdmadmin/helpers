...
const CreateProfile = (_: CreateProfileProps) => {
  const [genderType, setGenderType] = React.useState<number>(-1);
    ...
    <WrapperContainer isLoading={loading}>
      <ScrollView>
        <View style={{flex: 1, padding: 15}}>
          ...
          {/* <Text style={{...commonStyles.fontSize15Blue}}>{"Skip this step i'll do this later"}</Text> */}
